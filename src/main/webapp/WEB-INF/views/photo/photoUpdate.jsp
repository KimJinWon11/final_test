...
<body>
	...
	<section id="mainPage_base">
		<div id="mainPage_menu_front">
			...
			<form action="photoUpdate" method="post" id="frm" enctype="multipart/form-data">
			<input type="hidden" name="num" value="${photoDTO.num}">
			<p>작성자 : <input type="text" name="writer" value="${member.emp_name }"> </p>
			<p>제목 : <input type="text" name="title" value="${photoDTO.num }"> </p>
			<p>contents: <textarea id="smarteditor" rows="" cols="" name="contents">${photoDTO.contents }</textarea></p>
